    ...
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="py-4">
        {SidebarMenuItems.map((item, index) => (
          <Menu key={index}>
            <Menu.Button className="flex items-center justify-start px-4 py-3 text-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700">
              {item.icon}
                  ...
                  <Menu.Item key={subIndex}>
                    {({ active }) => (
                      <Link
                        ...
                        className={`${
                          active ? "bg-gray-100" : ""
                        } flex items-center justify-start px-4 py-3 text-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700`}
                      >
                        {subItem.icon}
