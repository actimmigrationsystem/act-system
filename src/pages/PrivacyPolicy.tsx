  ...
  return (
    <>
      <div className="max-w-4xl mx-auto p-8">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to ACT Immigration And Labour
              Consultants, 255 Caledon Street Central Kariega, Eastern Cape
              South Africa.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to ACTImmigration, accessible from{" "}
              <a
                href="https://www.actimmigration.co.za/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.actimmigration.co.za/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: info@actimmigration.co.za</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://www.actimmigration.co.za/privacypolicy"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.actimmigration.co.za/privacypolicy
              </a>
            </p>
          </li>
        </ul>
