              ...
              <Sidebar.Item>
                <StyledIcon>
                  <div
                    role="button"
                    tabIndex={0}
                    onClick={() => window.open('https://www.facebook.com/profile.php?id=100063622943110&ref=embed_page', '_blank', 'noopener noreferrer')}
                    onKeyDown={() => {}}
              ...
              <Sidebar.Item>
                <StyledIcon>
                  <div
                    role="button"
                    tabIndex={0}
                    onClick={() => window.open('https://api.whatsapp.com/send?phone=27723876910', '_blank', 'noopener noreferrer')}
                    onKeyDown={() => {}}
